...
type SortKey = "omschrijving" | "merk" | "model" | "winkel" | "bedrag" | "datum" | "levensduur_maanden" | "restwaarde";
...
export function InboedelTabel({ artikelen }: { artikelen: InboedelArtikel[] }) {
