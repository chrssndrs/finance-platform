...
SQL_LENINGDEEL_INVOEGEN = """
    INSERT INTO hypotheek.leningdelen
        (naam, type, hoofdsom, rente_percentage, startdatum, looptijd_maanden, rentevast_tot, aangemaakt_op)
    VALUES ($naam, $type, $hoofdsom, $rente_percentage, $startdatum, $looptijd_maanden, $rentevast_tot, now())
    RETURNING id
"""

SQL_LENINGDEEL_BIJWERKEN = """
    UPDATE hypotheek.leningdelen
    SET naam = $naam, type = $type, hoofdsom = $hoofdsom, rente_percentage = $rente_percentage,
